...
public class AdvancedBinaryConverter implements ActionListener {
	...
	String binaryToHex(String binaryStr) {
		try {
			int binaryInt = Integer.parseInt(binaryStr, 2);
			return "" + Integer.toHexString(binaryInt).toUpperCase();
		} catch (Exception e) {
			return "-";
		}
	}
