...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		JPanel header = createHeader("Coding");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == firstButton) {
			askQuestion("What kind of variable holds whole numbers?", "int", 200);
		}
		if (e.getSource() == secondButton) {
			askQuestion("<html> What is the largest number that can be returned by the following code?"
					+ "<br> int r = new Random().nextInt(100)</html>", "99", 400);
		}
		if (e.getSource() == thirdButton) {
			askQuestion(
					"If I had an array called penguin, what would I type to find the number of elements in the array?",
					"penguin.length", 600);
		}
		if (e.getSource() == fourthButton) {
			askQuestion("What is the value of 9 & (bitwise) 8", "8", 800);
		}
		if (e.getSource()==fifthButton) {
			askQuestion("<html>Any variable in mustaches {} can only be used in those mustaches. "
					+ "<br>Mustaches define a new ______</html>", "scope", 1000);
		}
